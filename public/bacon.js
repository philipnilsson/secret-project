...
(function() {
  ...
  Bacon.combineAsArray = function() {
    ...
    if (streams.length) {
      ...
      return new Property(function(sink) {
        var combiningSink, ends, i, index, initialSent, stream, _i, _len;
        ...
        initialSent = false;
        combiningSink = function(index) {
          return function(unsubAll) {
            var _this = this;

            return streams[index].subscribe(function(event) {
        ...
        return compositeUnsubscribe.apply(null, (function() {
          ...
          _results = [];
          for (i = _j = 0, _len1 = streams.length; _j < _len1; i = ++_j) {
            s = streams[i];
            _results.push(combiningSink(i));
          }
          return _results;
        })());
      });
  ...
  Observable = (function() {
    ...
    Observable.prototype.takeUntil = function(stopper) {
      ...
      return this.withSubscribe(function(sink) {
        ...
        composite.add(function(unsubBoth) {
        ...
        composite.add(function(unsubBoth) {
          return stopper.subscribe(function(event) {
            if (event.isError()) {
              return Bacon.more;
            } else if (event.isEnd()) {
              return Bacon.noMore;
    ...
    Observable.prototype.flatMap = function(f) {
      ...
      return new EventStream(function(sink) {
        ...
        composite.add(function(unsubAll, unsubRoot) {
  ...
  Bacon.when = function() {
    var fromStreams, i, index, ix, len, p, pat, pats, patterns, s, sources, src, usage, _i, _j, _k, _len, _len1, _len2, _ref3, _ref4, _ref5;
    ...
    i = 0;
    while (i < len) {
      if (!(patterns[i] instanceof Array)) {
        patterns[i] = [patterns[i]];
      }
      _ref3 = patterns[i];
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        p = _ref3[_i];
        assert(p instanceof Observable, usage);
      }
      if (!(patterns[i + 1] instanceof Function)) {
        patterns[i + 1] = (function() {
          return patterns[i + 1];
        });
      }
      pat = {
    ...
    src = (function() {
      function src(s) {
        ...
        if (s instanceof Property) {
          ...
          this.ended = function(c) {
            return this.queue.length < c && this.isEnded;
          };
        }
      }
    ...
    return fromStreams = new EventStream(function(sink) {
      var cannotMatch, match, part;

      match = function(p) {
        return _.all(p.ixs, function(i) {
          return sources[i.index].queue.length >= i.count;
        });
      };
      cannotMatch = function(p) {
        return _.any(p.ixs, function(i) {
          return sources[i.index].ended(i.count);
        });
      };
      part = function(source, j) {
        return function(unsubAll) {
          return source.obs.subscribe(function(e) {
            var reply, val, _l, _len3;
            ...
            if (e.isEnd()) {
              ...
              for (_l = 0, _len3 = pats.length; _l < _len3; _l++) {
                p = pats[_l];
                if (match(p)) {
                  val = p.f.apply(p, (function() {
                    ...
                    for (_m = 0, _len4 = _ref6.length; _m < _len4; _m++) {
                      i = _ref6[_m];
                      _results.push(sources[i.index].value());
                    }
                    return _results;
                  })());
                  reply = sink(next(val));
      ...
      return compositeUnsubscribe.apply(null, (function() {
        ...
        _results = [];
        for (i = _l = 0, _len3 = sources.length; _l < _len3; i = ++_l) {
          s = sources[i];
...
Bacon.update = function() {
  ...
  Bacon.makeFunction = makeFunction;
